...
{
	main.figure[5].type = ft_strdup("sphere");
	main.figure[5].pos.x = -2;
	main.figure[5].pos.y = -1.9;
	main.figure[5].pos.z = 12.1;
	main.figure[5].radius = 0.8;
	main.figure[5].color.r = 200;
	main.figure[5].color.g = 200;
	main.figure[5].color.b = 200;
